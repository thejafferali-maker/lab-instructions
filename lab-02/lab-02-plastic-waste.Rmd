...
Neither pair of variables appears to be strongly linearly associated. Both plots show a lot of scattered points with no clear linear pattern, but plastic waste per capita and coastal population appear slightly more related than plastic waste per capita and total population.
...
The plot shows a slight positive relationship between coastal population proportion and plastic waste per capita, meaning countries with more people living near the coast tend to produce a little more plastic waste per person. However, the relationship is weak because the points are spread out. There are some differences across continents, with Africa generally showing lower plastic waste per capita and Europe and North America often showing higher values, but overall the continents overlap and follow a similar pattern.
